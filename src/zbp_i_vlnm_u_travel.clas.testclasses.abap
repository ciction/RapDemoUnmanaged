CLASS ltcl_integration_test DEFINITION FINAL FOR TESTING
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE zi_vlnm_u_travel\\travel.
      ...
      MODIFY ENTITIES OF zi_vlnm_u_travel
        ENTITY travel
      ...
      SELECT * FROM zi_vlnm_u_travel WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zi_vlnm_u_travel' )
                                  ( i_for_entity = 'zi_vlnm_u_booking' ) )
                                ).
    ENDMETHOD.
